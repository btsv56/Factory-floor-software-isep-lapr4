...
**Pure Fabrication** - used in the creation of the class "ChangeProductionOrderStateUI", since no other rule can be applied to create it.

**Controller** - the class "ChangeProductionOrderStateController" controls the user case.
